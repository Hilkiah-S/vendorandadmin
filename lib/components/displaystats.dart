...
class DashboardStatisticsVendor extends StatefulWidget {
  @override
  State<DashboardStatisticsVendor> createState() =>
      _DashboardStatisticsStateVendor();
}

class _DashboardStatisticsStateVendor extends State<DashboardStatisticsVendor> {
  ...
  void getStats() async {
    ...
    Response<Map> response = await Dio()
        .get("https://api.semer.dev/api/supplier/analysis", options: options);
    print(response);
  ...
  Widget build(BuildContext context) {
    ...
    return recievedstats
        ? Padding(
            padding: const EdgeInsets.only(left: 10.0, right: 13.0, bottom: 35),
            child: Container(
