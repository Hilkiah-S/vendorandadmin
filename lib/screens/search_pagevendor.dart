...
class SearchPageVendor extends StatefulWidget {
  @override
  _SearchPageStateVendor createState() => _SearchPageStateVendor();
}

class _SearchPageStateVendor extends State<SearchPageVendor> {
  ...
  getSearches() async {
    ...
    try {
      ...
      Response<Map> response = await Dio().post(
          "https://api.semer.dev/api/supplier/search",
      ...
      if (response.statusCode == 200) {
        ...
        vendorsearchresult =
            dataList.map((e) => SearchVendorClass.fromMap(e)).toList();
        setState(() {});
      } else {
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Flexible(
            child: vendorsearchresult.length == 0
                ? Container(
                    color: Colors.white,
                  )
                : Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          SingleChildScrollView(
                                            ...
                                            child: Text(
                                              '${vendorsearchresult[index].product.description}', // Placeholder for any other detail you want to show
                                              style: TextStyle(
                                                fontSize: 14,
                                                color: Colors.grey[600],
                                              ),
